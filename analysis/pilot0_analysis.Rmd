...
geom_errorbar(aes(ymin = mean_rating-(sd_rating/sqrt(num_raters)), ymax = mean_rating+(sd_rating/sqrt(num_raters))), width=0.3)+
  ...
  theme_classic() +
  theme(axis.ticks.x=element_blank(),axis.text.x=element_blank(),axis.text=element_text(size=15, colour = 'black'),axis.title=element_text(size=14,face="bold"), strip.text = element_text(size=20,face="bold"),panel.background = element_rect(fill = "#595959",
                                colour = "#595959",
...
write.csv(ratings_mat, '../data/uw_58_ratings_matrix.csv')
...
if(!exists('ratings_mat')){
  ratings_mat = read.csv('../data/uw_58_ratings_matrix.csv')
}
...
p
ggsave( '../plots/shufVunshuf.pdf',plot=p,device = 'pdf',width = 10,height = 7)
